object frmRelProVenda2: TfrmRelProVenda2
  Left = 0
  Top = 0
  Caption = 'RELATORIO DE VENDA POR DATA'
  ClientHeight = 469
  ClientWidth = 798
  Color = clBtnFace
  ...
  object FDQVenda: TFDQuery
    ...
    SQL.Strings = (
      ...
      '    C.nome,'
      '    V.dataVenda,'
      '    CAST(V.totalVenda AS NUMERIC(18,3)) AS TotalVenda,'
    ...
    object FDQVendacreditoCliente: TFMTBCDField
